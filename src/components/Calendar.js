...
const CalendarMonthControl = (props) => {
    ...
    return (
        <div className="calendar-month-control">
            ...
            <span className="calendar-month">{months[month.getMonth()]} {month.getFullYear()}</span>
...
export const Calendar = (props) => {
    ...
    return (
        <div className="calendar-container">
            <CalendarMonthControl onPrevMonth={handlePrevMonth} onNextMonth={handleNextMonth} month={month} />
